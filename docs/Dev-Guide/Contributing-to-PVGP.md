...
## Feature Requests
We encourage users to submit ideas for improvements to PVGeophysics code base! Please create an issue on the [issues page](https://github.com/banesullivan/ParaViewGeophysics/issues) with a *Feature Request* label to suggest an improvement.
...
## Licensing
All contributed code will be licensed under [*PVGeophysics*'s' license](https://github.com/banesullivan/ParaViewGeophysics/blob/master/LICENSE). If you did not write the code yourself, it is your responsibility to ensure that the existing license is compatible and included in the contributed files or you can obtain permission from the original author to relicense the code.
