...
??? tip "Where to get the code"
    All code is published on the GitHub repository 'PVGeophysics' linked to this page. Click the 'PVGP on GitHub' link on the right side of the menu bar at the top to find all of the code.
