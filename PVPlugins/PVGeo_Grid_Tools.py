...
@smproxy.reader(extensions=SurferGridReader.extensions,
...
@smproxy.reader(extensions=EsriGridReader.extensions,
...
@smproxy.reader(extensions=LandsatReader.extensions,
