...
@smproxy.reader(
    name="PVGeoPackedBinariesReader",
...
class PVGeoPackedBinariesReader(PackedBinariesReader):
    ...
    @smproperty.xml(
        _helpers.get_file_reader_xml(
            PackedBinariesReader.extensions,
            reader_description=PackedBinariesReader.description,
        )
    )
...
class PVGeoXYZTextReader(XYZTextReader):
    ...
    @smproperty.xml(
        _helpers.get_file_reader_xml(
            XYZTextReader.extensions, reader_description=XYZTextReader.description
        )
    )
    def AddFileName(self, filename):
