...
You *MUST* change the `PVPATH` variable in [src/install_plugins.sh](install_plugins.sh) This variable is likely different depending on your OS and your version of ParaView. On MacOS, simply just replace `/ParaView-5.4.0.app/` with the name of your version of ParaView under `/Applications/`.
